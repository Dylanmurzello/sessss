...
chrome.runtime.sendMessage({ type: "getUid" }, function (response) {
    window.addEventListener("DOMContentLoaded", function () {
        ...
        document.body.setAttribute("data-sb-version", "1.8.0");
    });
});
